...
clc
clear all
[num,txt,raw]=xlsread('F:\BUAA\2022秋-人工智能课程大作业\混合高斯模型预测男女身高标准差\混合高斯数据集.xls','C5:C121');
%男女生共取2000人，女生平均身高163，男声平均身高180
%male=178+sqrt(8)*randn(1,1000);
%产生均值为180，方差为10的一个1*1000的随机数
%female=170+sqrt(10)*randn(1,1000);
h=num;
...
mu1_first=178;sigmal_first=8;w1_first=0.7;%男生的
mu2_first=165;sigma2_first=10;w2_first=0.3;%以我们学校理工院校为例
